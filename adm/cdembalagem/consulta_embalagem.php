...
$select = "SELECT * from tb_embalagem WHERE cl_descricao LIKE '%{$descricao}%' ";
$resultado_select = mysqli_query($conecta, $select);
    if(!$resultado_select){
        die("Falha na consulta ao banco de dados || tb_embalagem");
    }
}
...
<body>
    ...
    <main>
        <div id="janela_pesquisa">
            <a
                onclick="window.open('cadastro_embalagem.php', 
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
            ...
            <form action="" method="get">
                <input type="text" name="pesquisa" placeholder="Pesquisa / Unidade / Código " value="<?php if(isset($_GET['pesquisa'])){
                    echo $descricao;
                }?>">
...
if(isset($_GET["pesquisa"])){
      while($linha = mysqli_fetch_assoc($resultado_select)){
        $b_id = $linha["cl_id"];
        $b_embalagem= ($linha["cl_descricao"]);
        ...
        ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td style="width: 500px;">
                            <p>
                                <font size="2"><?php echo $b_embalagem; ?> </font>
                            </p>
                        </td>
                        ...
                        <td>
                            <a
                                onclick="window.open('editar_embalagem.php?codigo=<?php echo $b_id;?>', 
