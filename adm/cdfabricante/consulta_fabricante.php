...
$select = "SELECT * from tb_fabricante where cl_descricao LIKE '%{$descricao}%' ";
...
<body>
    ...
    <main>
        <div id="janela_pesquisa">
            <a
                onclick="window.open('cadastro_fabricante.php', 
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
            ...
            <form action="" method="get">
                <input type="text" name="pesquisa" placeholder="Pesquisa / Fabricante / Código " value="<?php if(isset($_GET['pesquisa'])){
                    echo $descricao;
                }?>">
      ...
      while($linha = mysqli_fetch_assoc($resultado_select)){
        ...
        ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td>
                            <a
                                onclick="window.open('editar_fabricante.php?codigo=<?php echo $b_id;?>', 
