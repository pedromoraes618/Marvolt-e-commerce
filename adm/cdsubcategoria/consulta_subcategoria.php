...
$select = "SELECT c.cl_descricao as categoria, s.cl_descricao, s.cl_id from tb_subcategoria as s inner join tb_categoria as c on c.cl_id = s.cl_categoria WHERE s.cl_descricao LIKE '%{$descricao}%' ";
        ...
        ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td style="width: 500px;">
                            <p>
                                <font size="2"><?php echo $b_subcategoria; ?> </font>
                            </p>
                        </td>
                        ...
                        <td>
                            <a
                                onclick="window.open('editar_subcategoria.php?codigo=<?php echo $b_id;?>', 
