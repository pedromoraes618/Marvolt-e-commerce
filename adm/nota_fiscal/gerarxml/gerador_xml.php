<?php
require_once "../../nfephp/vendor/autoload.php";
$caminhoCertificado = "../../nfephp/certs/1/certificado.pfx";
...
$config = [
   "atualizacao" => "2022-07-11 12:46:22",
...
$tools = new NFePHP\NFe\Tools($configJson, NFePHP\Common\Certificate::readPfx($certificadoDigital, '426986'));
